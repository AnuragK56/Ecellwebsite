...
<html dir="ltr" lang="en-US">
   <head>
      ...
      <title>Past Speakers | Entrepreneurship- Cell, MUJ</title>
   </head>
               ...
               <div class="container clearfix">
                  ...
                  <nav>
                     <ul>
                        ...
                        <li>
                           <a href="portfolio-3-nomargin.html">
                              <div>No Margin</div>
                           </a>
                        </li>
                        <li>
                           <a href="portfolio-3-notitle.html">
                              <div>No Title</div>
                           </a>
                        </li>
                        <li>
                           <a href="portfolio-3-title-overlay.html">
                              <div>Title Overlay</div>
                           </a>
                        </li>
                        <li>
                           <a href="portfolio-3-fullwidth.html">
                              <div>Full Width</div>
                           </a>
                        </li>
                        <li>
                           <a href="portfolio-3-fullwidth-notitle.html">
                              <div>Full Width - No Title</div>
                           </a>
                        </li>
                     </ul>
                  </nav>
