...
<html dir="ltr" lang="en-US">
   <head>
      ...
      <title>Alumini | Entrepreneurship- Cell, MUJ</title>
      <style>
                        ...
                        <div class="col-lg-6">
                           <form class="row" id="event-registration" action="http://themes.semicolonweb.com/html/canvas/include/form.php" method="post" enctype="multipart/form-data">
                              ...
                              <div class="col-6 form-group">
                                 ...
                                 <input type="text" name="alumni-first-name" id="alumni-first-name" class="form-control required" value="" placeholder="First Name">
                              </div>
                              <div class="col-6 form-group">
                                 <label>Last Name</label>
                                 <input type="text" name="alumni-last-name" id="alumni-last-name" class="form-control required" value="" placeholder="Last Name">
                              </div>
                              <div class="col-12 form-group">
                                 <label>Email:</label>
                                 <input type="email" name="alumni-email" id="alumni-email" class="form-control required" value="" placeholder="Email Address">
                              </div>
                              <div class="col-12 form-group">
                              ...
                              <div class="col-6 form-group">
                                ...
                                <select class="form-control" id="alumni-batch">
                              ...
                              <div class="col-6 form-group">
                                 ...
                                 <input type="text" name="alumni-city" id="alumni-city" class="form-control required" value="" placeholder="Current City">
                              </div>
                              <div class="col-6 form-group">
                                 <label>Registration Number</label>
                                 <input type="text" name="alumni-reg-no" id="alumni-reg-no" class="form-control required" value="" placeholder="Registration Number">
                              </div>
                              <div class="col-6 form-group">
                                 <label>Branch</label>
                                 <input type="text" name="alumni-branch" id="alumni-branch" class="form-control required" value="" placeholder="Branch">
                              </div>
