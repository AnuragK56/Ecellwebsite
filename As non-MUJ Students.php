...
<html dir="ltr" lang="en-US">
   <head>
      ...
      <title>As non-MUJ Students | Entrepreneurship- Cell, MUJ</title>
      <style>
                        ...
                        <div class="col-lg-6">
                           <form class="row" id="event-registration" action="http://themes.semicolonweb.com/html/canvas/include/form.php" method="post" enctype="multipart/form-data">
                              ...
                              <div class="col-6 form-group">
                                 ...
                                 <input type="text" name="nonmuj-student-first-name" id="nonmuj-student-first-name" class="form-control required" value="" placeholder="First Name">
                              </div>
                              <div class="col-6 form-group">
                                 <label>Last Name</label>
                                 <input type="text" name="nonmuj-student-last-name" id="nonmuj-student-last-name" class="form-control required" value="" placeholder="Last Name">
                              </div>
                              <div class="col-12 form-group">
                                 <label>Email:</label>
                                 <input type="email" name="nonmuj-student-email" id="nonmuj-student-email" class="form-control required" value="" placeholder="Email Address">
                              </div>
                              <div class="col-12 form-group">
                                 <label>Gender:</label><br>
                                 <div class="form-check form-check-inline">
                                    <input class="form-check-input required" type="radio" name="alumni-gender" id="alumni-gender-male" value="Male">
                                    <label class="form-check-label nott" for="alumni-gender-male">Male</label>
                                 </div>
                                 <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="alumni-gender" id="alumni-gender-female" value="Female">
                                    <label class="form-check-label nott" for="alumni-gender-female">Female</label>
                                 </div>
                              </div>
                              ...
                              <div class="col-6 form-group">
                                 ...
                                 <input type="text" name="muj-student-phone-number" id="muj-student-phone-number" class="form-control required" value="" placeholder="Phone Number">
                                 
                              </div>
                              <div class="col-6 form-group">
                                  <label>Whatsapp Number</label>
                                     <input type="text" name="muj-student-whatsapp-number" id="muj-student-whatsapp-number" class="form-control required" value="" placeholder="Whatsapp Number">
                                </div>
                              ...
                              <div class="col-6 form-group">
                                 ...
                                 <input type="text" name="nonmuj-student-college-name" id="nonmuj-student-college-name" class="form-control required" value="" placeholder="College Name">
                              </div>
                              <div class="col-6 form-group">
                                 <label>City</label>
                                 <input type="text" name="nonmuj-student-city" id="nonmuj-student-city" class="form-control required" value="" placeholder="City">
                              </div>
                              <div class="col-6 form-group">
                                 <label>Roll Number</label>
                                 <input type="text" name="nonmuj-student-roll-no" id="nonmuj-student-roll-no" class="form-control required" value="" placeholder="Roll Number">
                              </div>
                              <div class="col-6 form-group">
                                 <label>Branch</label>
                                 <input type="text" name="nonmuj-student-branch" id="nonmuj-student-branch" class="form-control required" value="" placeholder="Branch">
                              </div>
