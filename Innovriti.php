...
<html dir="ltr" lang="en-US">
   <head>
      ...
      <title>Innovriti | Entrepreneurship- Cell, MUJ</title>
   </head>
         ...
         <section id="content">
            <div class="content-wrap">
               <div class="container clearfix">
                  ...
                  <div class="container clearfix">
                     <h1>WHAT IS IT?</h1>
                     <h2><p>Innovriti is a platform where a plethora of ideas come across and the best few are recognized by a highly experienced panel of judges and established innovators and entrepreneurs.</p></h2>
                     <br>
                     <h3><p>It will not only provide an opportunity to present ideas, but also a basic overview of how to go ahead with it, and understand its scope for further development. We offer an opportunity for all startups to contact and interact with startup mentors prior to the event. After the informal session, the Startups would get a chance to present their idea in front of the judging panel. The selected teams would get a chance to pitch in the final round in front of incubators, investors and mentors.<br>
                     This year too, we plan to organize the same event in the upcoming E-Conclave with even more enthusiasm and intellect. The event begins with the first round being the online round, followed by the online mentoring round and ends with the physical round.</p></h3>
                  </div>
                  <div class="container clearfix">
                     <h1>WHAT YOU GET ?</h1>
                     <p><h3>The qualifying teams would be vying in front of investors, prizes worth 5 Lacks(Incubation included) to be won. There will be a networking dinner for all the teams that qualified for the 2nd round on the same day, where you will get a golden opportunity to interact with mentors, investors and other participants and take benefit of their presence.</h3></p>
                  </div>
                  ...
                  <div class="container clearfix">
                     <h2>Flow of Innovriti:</h2>
                     <h2><strong>Mentoring Round + Elevator Pitch ---> B-Plan Presentation</strong></h2>
                  </div>
                  <div class="container clearfix">
                     <h1>About Innovriti 2019</h1>
                     <p><h3>Innovriti was organized on 8th February 2019 in Smt Sharada Pai Auditorium. It was the major event of E-Conclave. There were 39 teams out of which 26 teams had participated after screening round (online round). In this business plan pitching event, the first round was the mentoring round. In which the participants were allotted a mentor and each team got 30 minutes to interact with their mentor for clarifying the doubts and finding ways in improving their startups. Some of the mentors were- Dr Dhariwal, Ms Snigdha Sharma, Mr Rajeev Joshi, Mr Anshul Patidar and Mr Kapil Goyal. These mentors were tremendously guided their teams in the right way. The mentoring sessions were highly interactive and fruitful.</h3></p>
                  <div class="clear"></div>
