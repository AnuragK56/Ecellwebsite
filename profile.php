...
<html dir="ltr" lang="en-US">
   <head>
      ...
      <title>Member's Profile | Entrepreneurship- Cell, MUJ</title>
   </head>
                  ...
                  <div class="row clearfix">
                           ...
                           <div class="col-lg-12">
                              <div class="tabs tabs-alt clearfix" id="tabs-profile">
                                 <ul class="tab-nav clearfix">
                                    <li><a href="#tab-details"><i class="icon-rss2"></i> My Details</a></li>
                                    <li><a href="#tab-events"><i class="icon-pencil2"></i> Upcoming Events</a></li>
                                    <li><a href="#tab-announcements"><i class="icon-reply"></i> Announcements</a></li>
                                 </ul>
                                 <div class="tab-container">
                                                ...
                                                <div class="row clearfix">
                                                   <div class="col-md-4">
                                                      <div class="entry-image">
                                                         <a href="images/portfolio/full/17.html" data-lightbox="image"><img class="image_fade" src="images/blog/grid/17.jpg" alt="Standard Post with Image"></a>
                                                      </div>
                                                   </div>
                                                   <div class="col-md-8">
                                    ...
                                    <div class="tab-content clearfix" id="tab-announcements">
                     ...
                     <div class="col-md-3 clearfix">
                        <div class="list-group">
                           <a href="#" class="list-group-item list-group-item-action clearfix">Change Password <i class="icon-lock float-right"></i></a>
                           <a href="#" class="list-group-item list-group-item-action clearfix">Contact Us <i class="icon-envelope float-right"></i></a>
                        ...
                        <a href="#" class="social-icon si-istagram si-small si-rounded si-light" title="Instagram">
