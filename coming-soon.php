...
<html dir="ltr" lang="en-US">
	<!-- Mirrored from themes.semicolonweb.com/html/canvas/coming-soon.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 13 Jun 2019 10:20:04 GMT -->
	<head>
				...
				<div id="header-wrap">
					<div class="container clearfix">
						<div id="logo" class="divcenter">
							...
							<a href="index.html" class="retina-logo" data-dark-logo="images/logo-dark@2x.png"><img class="divcenter" src="images/logo%402x.png" alt="Canvas Logo"></a>
						</div>
					</div>
				</div>
			</header>
						...
						<form id="widget-subscribe-form" action="http://themes.semicolonweb.com/html/canvas/include/subscribe.php" role="form" method="post" class="nobottommargin">
							<div class="input-group input-group-lg divcenter" style="max-width:600px;">
								...
								<div class="input-group-append">
									<button class="btn btn-secondary" type="submit">Get Notified</button>
								</div>
							</div>
						</form>
					</div>
